...
public class SucursalForm extends javax.swing.JDialog {
    ...
    public void recibirDatosDreccion(String departamento, String zona, String TipoCalle, String numero1, String numero2, String numero3) {
        String sucursal = txtSucursal.getText();
        if (sucursal.isEmpty()) {
            String query = "INSERT INTO `direccion `(`zona`,`tipoCalle`,`numero1`,`numero2`,`numero3`,`nombreDepartamento`)VALUES('"
                    + zona + "','" + TipoCalle + "','" + numero1 + "','" + numero2 + "','" + numero3 + "','" + departamento + "');";
            try {
            ...
            System.out.println(e);
                ...
                System.out.println(e);
                JOptionPane.showMessageDialog(this, "No se puede añadir la Sucursal", "", JOptionPane.ERROR_MESSAGE);
            }
